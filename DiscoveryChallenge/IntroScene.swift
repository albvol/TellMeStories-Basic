...
class IntroScene: Intro {
    ...
    override func didMove(to view: SKView) {
        ...
        if (Language.getLanguage() == "it-IT") {
            ...
            txt1 = "In Argolis, historical region of the ancient Greece, there was a valley called Nemea where  he lived a terrible lion, born of Typhon and Echidna, who terrified all men. This lion was invulnerable, no weapon was able to scratch its hard skin; fangs and claws were tough as metal. Let’s join to Heracles in this exciting adventure e let’s discover how the Lion constellation was born. All started in Mycenae"
        }
