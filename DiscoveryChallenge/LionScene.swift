...
struct Settings {
    struct Metrics {
        ...
        static let projectileRestPosition = CGPoint(x: 100, y: 50)
...
class LionScene: SKScene, SKPhysicsContactDelegate  {
    ...
    override func didMove(to view: SKView) {
        ...
        let base = Sprite(usingImage: "LionEnvironmentBase", referredWithName: "Base", withAlpha: CGFloat(0.3), onLayer: CGFloat(0))
